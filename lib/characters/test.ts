// Test file for character system
import { getCharacterImplementation, getAllCharacterImplementations } from './characterFactory';
import { Vector, PhysicsWorld, CircleEntity } from '../physics';

/**
 * Test function to verify character system implementation
 */
export function testCharacterSystem(): void {
  console.log('Testing character system...');
  
  // Create a mock world for testing
  const mockWorld: PhysicsWorld = {
    entities: new Map(),
    gravity: { x: 0, y: 0 },
    airFriction: 0.01,
    timeAccumulator: 0,
