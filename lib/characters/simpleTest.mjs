// Simple test script for character system (ES modules version)
import { getCharacterImplementation, getAllCharacterImplementations } from '../characters/characterFactory.js';
